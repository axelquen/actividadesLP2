    ...
    public void menu(ListaDeBilletes listaDeBilletes) {
        ...
        do {
            try {
                ...
                System.out.println("Cantidad mínima a retirar: $" + listaDeBilletes.obtenerCantidadMinimaRetiro()+"\n");
                System.out.println("1. Consultar saldo \n2. Retirar efectivo \n3. Salir");
                System.out.println("(Si escribe opciones separadas por espacio, no se tomará lo escrito después del espacio.)");
