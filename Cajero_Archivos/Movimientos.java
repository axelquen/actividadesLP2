...
public class Movimientos implements Serializable {
    ...
    public Movimientos(String accion, String usuario, float saldo, float retiro, boolean seRealizo,
    ...
    public float realizarRetiro(float saldo, float retiroDeseado, ListaDeBilletes listaDeBilletes) {
        if (!esRetiroValido(retiroDeseado)) {
            ...
            if (retiroDeseado != (int) retiroDeseado) {
                System.out.println("Ingresa un valor numérico entero para el retiro");
                return saldo;
            }
            ...
            listaDeBilletes.guardarBilletes();
            saldo -= retiroDeseado;
            this.seRealizo = true;
            return saldo;
        }
    ...
    public boolean esRetiroValido(float retiroDeseado) {
        ...
        if (retiroDeseado == 0) {
            System.out.println("No puedes poner 0 como monto a retirar");
            return false;
        }
